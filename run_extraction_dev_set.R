...
# Setting
pdf_folder <- "/Users/wangyuqi/Desktop/30 test_"
output_csv <- file.path(pdf_folder, "meta_analysis_run1.csv")
test_one_only <- FALSE
model_name     <- "gpt-5.5"
...
c(R = R.version.string,
  pdftools = as.character(packageVersion("pdftools")),
  openai   = as.character(packageVersion("openai")),
  jsonlite = as.character(packageVersion("jsonlite")),
  dplyr    = as.character(packageVersion("dplyr")))
for (p in c("pdftools","openai","jsonlite","dplyr")) print(citation(p))
